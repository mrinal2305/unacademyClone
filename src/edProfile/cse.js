          ...
          <div class="cse-card">
            ...
            <div class="cse-detail-wrapper">
              <div >
                ...
                <a class="cse-detail-anchor"><h6 class="cse-detail-h6">Detailed Course on Constitutional Framework</h6></a>
                <p class="cse-end">Ended on Jun 30, 2019 � 19 lessons</p>
              </div>
              <div class="aFrHS"></div>
              <a class="cse-anchor"><p class="cse-anchor-p">Nidhi Gaur</p></a>
            </div>
          </div>
        </div>
        ...
        <div class="cse-item">
          <div class="cse-card">
            ...
            <div class="cse-detail-wrapper">
              <div >
                <div class="cse-course-info">
                  <span class="cse-kXAzmG">Hindi</span>
                  <a class="kxOnID" href="/goal/upsc-civil-services-examination-ias-preparation/KSCGY/topic/JJZOS">
                  <span class="eyjAIn">Polity,
                        Governance &amp; IR</span>
                  </a>
                </div>
                <a class="cse-detail-anchor"><h6 class="cse-detail-h6">Detailed Course on Union and State Government</h6></a>
                <p class="cse-end">Ended on Aug 25, 2019 � 19 lessons</p>
              </div>
              <div class="aFrHS"></div>
              <a class="cse-anchor"><p class="cse-anchor-p">Nidhi Gaur</p></a>
            </div>
