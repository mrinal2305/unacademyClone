        ...
        <div class="card">
          <a class="exwfAE" href="/course/constitutional-framework-part-i-laxmikant-201/1VZRVCHI">
            <div orientation="vertical" class="fWbtym hfNpQJ">
              ...
              <button class="MuiButtonBase-root MuiIconButton-root IconButtons__StyledIconButton-sc-160l35g-0 dJlweQ FreeCourseCard__EnrollButton-sc-1xgmvj3-1 cXCTyO" tabindex="0" type="button" bgcolor=""><span class="MuiIconButton-label"><svg width="20px" height="20px" viewBox="0 0 80 80" class=""><path d="M63.333 72.5c-0.361-0.002-0.705-0.075-1.018-0.207l0.018 0.007-22-9.433c-0.097-0.048-0.212-0.076-0.333-0.076s-0.236 0.028-0.338 0.078l0.005-0.002-22 9.433c-0.294 0.131-0.637 0.208-0.998 0.208-0.509 0-0.983-0.152-1.378-0.414l0.009 0.006c-0.68-0.462-1.123-1.228-1.133-2.098v-53.335c0-5.063 4.104-9.167 9.167-9.167v0h33.333c5.063 0 9.167 4.104 9.167 9.167v0 53.333c-0.010 0.872-0.454 1.638-1.124 2.094l-0.009 0.006c-0.383 0.251-0.852 0.4-1.356 0.4-0.004 0-0.007 0-0.011 0h0.001zM40 57.8c0.843 0.007 1.644 0.178 2.375 0.482l-0.042-0.015 18.5 7.933v-49.533c0-2.301-1.865-4.167-4.167-4.167v0h-33.333c-2.287 0.019-4.133 1.877-4.133 4.167 0 0 0 0 0 0v0 49.533l18.533-7.933c0.669-0.287 1.447-0.458 2.263-0.467h0.003z" fill="#3C4852">
              </path></svg></span></button>
              <span type="filled" class="Tags-ctt3gx-0 FreeCourseCard__ItemsTag-sc-1xgmvj3-0 hZQGvw">13 lessons</span>  
            </div>
          </a>
              ...
              <div class="StarRating__Flex-auf177-0 etCuDU">
                <svg width="12px" height="12px" viewBox="0 0 80 80" class="">
                  <path d="M72.367 32.5c-0.296-0.892-1.055-1.552-1.986-1.698l-0.014-0.002-19.433-2.833-8.7-17.6c-0.462-0.765-1.289-1.269-2.233-1.269s-1.771 0.504-2.227 1.257l-0.007 0.012-8.7 17.6-19.433 2.833c-1.211 0.188-2.126 1.223-2.126 2.472 0 0.704 0.291 1.34 0.759 1.794l0.001 0.001 14.033 13.7-3.333 19.333c-0.023 0.127-0.036 0.274-0.036 0.423 0 0.836 0.405 1.577 1.029 2.038l0.007 0.005c0.374 0.235 0.829 0.375 1.317 0.375s0.942-0.14 1.327-0.381l-0.010 0.006 17.4-8.967 17.367 9.133c0.337 0.188 0.739 0.299 1.166 0.3h0c0.001 0 0.003 0 0.005 0 1.381 0 2.5-1.119 2.5-2.5 0-0.153-0.014-0.303-0.040-0.449l0.002 0.015-3.333-19.333 14.033-13.7c0.485-0.452 0.787-1.094 0.787-1.806 0-0.272-0.044-0.533-0.125-0.778l0.005 0.017z" fill="#FFAD3B">
                    ...
                    <h6 color="#FFAD3B" class="H7-sc-17eyqzc-0 StarRating__Rating-auf177-1 caeqxH FreeCourseCardDetails__Rating-sc-1xm9ymu-6 jHXkvM">5</h6>
        ...
        <div class="card">
          <a class="exwfAE" href="/course/constitutional-framework-part-i-laxmikant-201/1VZRVCHI">
            <div orientation="vertical" class="fWbtym hfNpQJ">
              ...
              <span type="filled" class="Tags-ctt3gx-0 FreeCourseCard__ItemsTag-sc-1xgmvj3-0 hZQGvw">6 lessons</span>  
            </div>
          </a>
        ...
        <div class="card">
          <a class="exwfAE" href="/course/constitutional-framework-part-i-laxmikant-201/1VZRVCHI">
            <div orientation="vertical" class="fWbtym hfNpQJ">
              ...
              <span type="filled" class="Tags-ctt3gx-0 FreeCourseCard__ItemsTag-sc-1xgmvj3-0 hZQGvw">30 lessons</span>  
            </div>
          </a>
