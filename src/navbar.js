            ...
            <header class="header">
                <div class="header_parent">
                    ...
                    <button type="button" class="header-button">
                        IIT JEE
                <svg width="16px" height="16px" viewBox="0 0 80 80" class="header-svg">
                            <path
                    ...
                    <div class="header-search">
                        <div class="header-svg-2" currentselecteditem="-1">
                            <div class="header-svg-3">
                                <svg width="24px" height="24px" viewBox="0 0 80 80" class="header-svg-4">
                                    <path
                            ...
                            <input autocomplete="off" type="text" value="" placeholder="Search" class="header-input" />
                            <fieldset class="header-fieldset">
                                <legend class="header-legend"></legend>
                            </fieldset>
                        </div>
                    </div>
